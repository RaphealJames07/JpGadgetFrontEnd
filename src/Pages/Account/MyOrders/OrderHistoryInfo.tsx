            ...
            <div className="w-full h-max ">
                <div className="w-full h-max flex flex-col justify-between px-20 phone:px-5 py-5 bg-slate-100">
                    <div className="w-full h-14 flex items-center justify-between">
                        <p className="w-max phone:w-full h-full flex items-center justify-between text-2xl font-medium">
                            Order Details
                        </p>
                        <NavLink to={"/my-orders"}>
                            <div className="w-max h-max hover:transform-cpu px-3 py-1 bg-gray-300 rounded flex items-center">
                                <IoMdArrowRoundBack />
                                Back To History
                            </div>
                        </NavLink>
