...
import ConsolesCarousel from "./ConsolesCarousel";
import ConsolesFilter from "./ConsolesFilter";
import ConsolesProducts from "./ConsolesProducts";
        ...
        <div className="w-full h-max">
            ...
            <div className="w-full h-max">
                <div className="w-full h-12 flex items-center justify-between px-44 phone:px-5 bg-gray-100">
                    <div className="text-xl font-semibold phone:text-base">
                        <p className="phone:hidden">Consoles</p>
                        <p
            ...
            <div className="w-full h-max">
                <div className="w-full h-max px-44 phone:px-3 py-5 flex justify-between">
                    <ConsolesFilter />
                    <ConsolesProducts isColumn={isColumn} />
                </div>
            </div>
            <Drawer
                title="Filter"
