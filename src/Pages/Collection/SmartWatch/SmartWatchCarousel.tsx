    ...
    return (
        <div className="relative">
            <OwlCarousel {...owlOptions} className="w-full ">
                ...
                <div className="item w-full h-[70vh]  ">
                    <div className="w-full h-full flex items-center justify-center ">
                        <div className="smartWatchColBg2">
                            <div className="w-full h-full bg-[#00000089] flex items-center justify-center flex-col gap-5 text-white">
                                <p className="text-5xl">Samsung Smart</p>
                                <p className="w-[90%] text-center items-center justify-center">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Cumque, explicabo
                                    dignissimos quia labore quasi excepturi
                                    fugiat ut sit asperiores numquam amet ullam
                                    nisi earum inventore tempora nam
                                    consequuntur harum aliquam.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="item w-full h-[70vh]  ">
                    <div className="w-full h-full flex items-center justify-center ">
                        <div className="smartWatchColBg3">
                            <div className="w-full h-full bg-[#00000089] flex items-center justify-center flex-col gap-5 text-white">
                                <p className="text-5xl">Hublot</p>
                                <p className="w-[90%] text-center items-center justify-center">
                                    Lorem ipsum dolor sit amet consectetur
                                    adipisicing elit. Cumque, explicabo
                                    dignissimos quia labore quasi excepturi
