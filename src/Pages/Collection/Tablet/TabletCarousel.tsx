            ...
            <OwlCarousel {...owlOptions} className="w-full ">
                ...
                <div className="item w-full h-[70vh]  ">
                    <div className="w-full h-full flex items-center justify-center ">
                        <div className="tabColBg1">
                            <div className="w-full h-full bg-[#00000089] flex items-center justify-center flex-col gap-5 text-white">
                                <p className="text-5xl">Samsung Tablet</p>
                                <p className="w-[90%] text-center items-center justify-center">
                                    Lorem ipsum, dolor sit amet consectetur
                                    adipisicing elit. Harum tempora cum commodi
                                    beatae, asperiores assumenda nesciunt et,
                                    perspiciatis animi eos accusantium deleniti
                                    quis officia, nam numquam tempore velit.
                                    Obcaecati, dolor.
                                </p>
                            </div>
                        </div>
