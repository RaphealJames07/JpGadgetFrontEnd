...
const Product = () => {
    ...
    return (
        <>
            <div className="w-full h-max min-h-[50vh] flex flex-col px-44 phone:px-5 py-5 gap-10 bg-slate-300">
                <div className="w-full h-max min-h-full  flex flex-col gap-2 text-gray-600 bg-[#f2f6f9] px-3 pt-1 pb-5">
                        ...
                        <div className=" h-max p-2 phone:w-full viewproductdetailrightbox">
                            <div className="w-full h-max flex flex-col gap-4">
                                ...
                                <div className="w-full h-max flex flex-col gap-2">
                                    ...
                                    <p className="text-xs">
                                        Tommy Hilfiger men striped pink
                                        sweatshirt. Crafted with cotton.
                                        Material composition is 100% organic
                                        cotton. This is one of the world’s
                                        leading designer lifestyle brands and is
                                        internationally recognized for
                                        celebrating the essence of classic
                                        American cool style, featuring preppy
                                        ...
                                        {showSpec ? (
                                            ...
                                            <div className="w-full h-max flex flex-col gap-3">
                                                ...
                                                <p className="text-xs">
                                                    ...
                                                    elit. Placeat tempora quis
                                                    sunt expedita esse natus
                                                    nihil. Placeat tenetur quod
                                                    consectetur laborum nobis
                                                    nostrum, dolor delectus amet
                                                    non explicabo architecto
                                                    exercitationem error ratione
                                                    totam dolorum dicta aperiam!
                                                    Ad, laboriosam voluptatum
                                                    quaerat, deleniti quasi quod
                                                    vitae dolore natus, rem est
                                                    excepturi. Animi beatae
                                                    necessitatibus illo mollitia
                                                    totam placeat fuga atque
                                                    architecto delectus
                                                    doloremque ipsam, saepe at,
                                                    ratione, deserunt molestiae
                                                    earum qui nihil maiores
                                                    praesentium aspernatur
                                                    voluptatem itaque! Quos,
                                                    sequi sit soluta veniam at
                                                    itaque id maiores debitis
                                                    ab, ratione, asperiores
                                                    corrupti ex quo? Distinctio
                                                    odit magnam suscipit
                                                    voluptatibus. Culpa sapiente
                                                    debitis repellendus.
                                                </p>
                                            </div>
                                        ) : showReview ? (
                    ...
                    <div className="w-full h-max flex gap-4 items-center justify-center">
                        <button className="w-max h-12 px-4 rounded font-semibold text-xs bg-green-800 text-white">Add To Cart</button>
                        <button className="w-max h-12 px-4 rounded font-semibold text-xs bg-blue-800 text-white">Add To Wishlist</button>
                    </div>
                </div>
            </div>
        </>
